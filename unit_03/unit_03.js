...
const inp1 = document.querySelector('.i-31');
const inp2 = document.querySelector('.i-32');
...
function f7(){
   const i1 = document.querySelector('.i-71').value;
   const i2 = document.querySelector('.i-72').value;
...
function f9(){
   let sel = +document.querySelector('.i-9').value;
   let out = document.querySelector('.out-9');

   if (sel > 1 && sel < 33) {
      out.innerHTML = 1;
   } else if (sel > 32 && sel < 44) {
      out.innerHTML = 2;
   } else if (sel > 44 && sel < 65) {
      out.innerHTML = 3;
   } else {
      out.innerHTML = 0;
   }
...
function f14(){
   ...
   switch (s) {
      case '+':
         out14.innerHTML = i1 +i2; // и так далее...
   }    
}
