...
function t8() {
    ...
    let data = document.querySelector('.i-8'); // получили значение
    // тут выводим
    document.querySelector('.out-8').textContent = data.value;
    data.value = '';
}
...
function t10() {
    ...
    div10.innerHTML = inp10.value * 20;
}
...
function t11() {
    ...
    div11.innerHTML = +inp11.value + 55;
}
...
function t12() {
    let i1 = document.querySelector('.i-12-1').value;
    let i2 = document.querySelector('.i-12-2').value;
    let out12 = document.querySelector('.out-12');

    out12.innerHTML = `Hello ${i1} ${i2}`;
}
